...
{
    public abstract class ShopifyServiceT<T, F> where T:class where F:class
    {
        ...
        protected ShopifyServiceT(string myShopifyUrl, string shopAccessToken)
        {
        ...
        public virtual async Task<T> UpdateAsync(long productVariantId, T Product)
        {
            throw new NotImplementedException();
        }
    }
